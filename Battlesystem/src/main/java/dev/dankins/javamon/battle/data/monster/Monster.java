...
import dev.dankins.javamon.data.monster.Color;
import dev.dankins.javamon.data.monster.GenderRatio;
import dev.dankins.javamon.data.monster.Genus;
import dev.dankins.javamon.data.monster.Growth;
import dev.dankins.javamon.data.monster.Habitat;
import dev.dankins.javamon.data.monster.MultiType;
import dev.dankins.javamon.data.monster.Shape;
import dev.dankins.javamon.data.monster.Stat;
import dev.dankins.javamon.data.monster.Type;

public class Monster implements dev.dankins.javamon.data.monster.Monster {
	...
	@JsonIgnore
	public Attack getMove(final String attackName) {
		return cachedAttacks.get(attackName);
	}
