...
public class EncounterListLoader
		extends SynchronousAssetLoader<EncounterList, EncounterListLoader.Parameters> {

	private final ObjectMapper mapper;

	public EncounterListLoader(final ObjectMapper mapper, final FileHandle directory) {
		super(new FileHandleResolver() {
			@Override
			public FileHandle resolve(final String mapName) {
				return new FileHandle("maps/" + mapName.split("-")[0] + "/encounter.yaml");
			}
		});
		this.mapper = mapper;
	}
	...
	@Override
	public EncounterList load(final AssetManager assetManager, final String fileName,
